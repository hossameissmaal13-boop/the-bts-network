...
export default function Ai({ navigation, route }) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.container}>
          <Text style={styles.title}>{t.homeAi || "AI"}</Text>

          <View style={styles.card}>
            <Text style={styles.text}>AI page coming soon...</Text>
          </View>
        </ScrollView>

        <View style={styles.bottomBar}>
          <ServicesRow navigation={navigation} currentScreen="Ai" student={student} t={t} />
        </View>
      </View>
    </SafeAreaView>
  );
